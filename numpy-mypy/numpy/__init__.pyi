...
from typing import (Any, Callable, Dict, Generic, Iterator, List, Optional, Sequence, Tuple, Type,
                    TypeVar, Union, Sized, overload, Iterable)

from numpy import random, linalg, math, fft
...
class _ArrayLike(Generic[_S], Iterable):
    """
    ...
    def max(self, axis: AxesType=None,
            out: '_ArrayLike[_U]'=None) -> Union['_ArrayLike[_S]', '_ArrayLike[_U]']: ...
    def mean(self, axis: AxesType = None, dtype: DtypeType = None,
             out: '_ArrayLike[Any]' = None, keepdims: bool = False
             ) -> Union['_ArrayLike[_S]', '_ArrayLike[floating]']: ...
...
class generic(_ArrayLike[_S], Generic[_S], Iterable[_S]): ...
...
class ndarray(_ArrayLike[_S], Generic[_S], Iterable, Sized):
    """numpy.ndarray"""
    ctypes = None    # type: Any  # TODO Implement ctypes type hint
    T = None         # type: ndarray[_S]
    ...
    # Magic methods
    def __abs__(self) -> 'ndarray[_S]': ...
    def __add__(self, value: object) -> 'ndarray[Any]': ...
    def __and__(self, value: object) -> 'ndarray[int]': ...
    def __array__(self, dtype: DtypeType = None) -> 'ndarray[Any]': ...
    def __array_prepare__(self, context: object = None) -> 'ndarray[Any]': ...
    def __array_wrap__(self, context: object = None) -> 'ndarray[Any]': ...
    def __copy__(self) -> 'ndarray[_S]': ...
    def __deepcopy__(self) -> 'ndarray[_S]': ...
    def __divmod__(self, value: object) -> Tuple['ndarray[int]', 'ndarray[float]']: ...
    def __eq__(self, value: object) -> 'ndarray[bool]': ...  # type: ignore
    def __floordiv__(self, value: object) -> 'ndarray[int]': ...
    ...
    def __or__(self, value: object) -> 'ndarray[_S]': ...
    def __pos__(self) -> 'ndarray[_S]': ...
    def __pow__(self, value: object) -> 'ndarray[Any]': ...
    def __radd__(self, value: object) -> 'ndarray[Any]': ...
    def __rand__(self, value: object) -> 'ndarray[_S]': ...
    def __rdivmod__(self, value: object) -> Tuple['ndarray[int]', 'ndarray[float]']: ...
    def __rfloordiv__(self, value: object) -> 'ndarray[Any]': ...
    def __rlshift__(self, value: object) -> 'ndarray[Any]': ...
    def __rmatmul__(self, value: object) -> 'ndarray[Any]': ...
    def __rmod__(self, value: object) -> 'ndarray[Any]': ...
    def __rmul__(self, value: object) -> 'ndarray[Any]': ...
    def __ror__(self, value: object) -> 'ndarray[_S]': ...
    def __rpow__(self, value: object) -> 'ndarray[Any]': ...
    def __rrshift__(self, value: object) -> 'ndarray[Any]': ...
    def __rshift__(self, value: object) -> 'ndarray[Any]': ...
    def __rsub__(self, value: object) -> 'ndarray[Any]': ...
    def __rtruediv__(self, value: object) -> 'ndarray[Any]': ...
    def __rxor__(self, value: object) -> 'ndarray[_S]': ...
    def __sub__(self, value: object) -> 'ndarray[Any]': ...
    def __truediv__(sel, value: object) -> 'ndarray[Any]': ...
    def __xor__(self, value: object) -> 'ndarray[_S]': ...

    def copy(self, order: str='C') -> 'ndarray[_S]': ...
    def flatten(self, order: str = 'C') -> 'ndarray[_S]': ...
    ...
    def mean(self, axis: AxesType = None, dtype: DtypeType = None,
             out: _ArrayLike[Any] = None, keepdims: bool = False
             ) -> Union[ndarray[_S], ndarray[floating]]: ...
...
def asfortranarray(a: _ArrayLike[_S], dtype: DtypeType = None) -> ndarray: ...
...
def fromiter(iterable: Iterator[Any], dtype: DtypeType, count: int=-1) -> ndarray[Any]: ...
...
def any(a: _ArrayLike[_S], axis: AxesType = None, out: '_ArrayLike[_U]' = None,
...
def argmin(a: _ArrayLike[_U], axis: int=None,
        out: ndarray[_U]=None) -> Union[ndarray[_U], ndarray[int]]: ...
def arange(bound1: _S, bound2: _S = None,
           bound3: _S = None, dtype: DtypeType = None) -> ndarray[_S]: ...
def argsort(a: _ArrayLike[Any], axis: int=None, kind: str='quicksort',
            order: OrderType=None) -> ndarray[int]: ...
def append(a: _ArrayLike[_S], values: _ArrayLike[_S], axis: int = None) -> ndarray[_S]: ...
...
def cumsum(a: _ArrayLike[_S], axis: int = None, dtype: DtypeType = None,
           out: ndarray[_U] = None) -> ndarray[Any]: ...
...
def fliplr(m: _ArrayLike[_S]) -> ndarray[_S]: ...
def flipud(m: _ArrayLike[_S]) -> ndarray[_S]: ...
...
def interp(x: _ArrayLike[float], xp: Sequence[float], fp: Sequence[_S],
           left: complex = None, right: complex = None, period: float = None
           ) -> ndarray[_S]: ...
def linspace(start: float, stop: float, num: int = 50, endpoint: bool = True,
             dtype: DtypeType = None
             ) -> ndarray: ...  # TODO retstep argument (changes return type) FORBIDDEN with this signature
...
def meshgrid(*xi: Sequence[_ArrayLike], indexing: str = 'xy',
...
def modf(a: _ArrayLike[floating]) -> Tuple[ndarray[floating], ndarray[floating]]:...
def nan_to_num(x: _ArrayLike[Any]) -> ndarray[Any]: ...
def polyfit(x: _ArrayLike[_S], y: _ArrayLike[_S], deg: int, rcond: float = None,
            w: _ArrayLike[float] = None,) -> ndarray: ...  # TODO args full and cov forbidden, change output signature
def reshape(a: _ArrayLike[_S], newshape: ShapeType, order: str = 'C') -> ndarray[Any]: ...
def repeat(a: _ArrayLike[_S], repeats: Union[int, Sequence[int]], axis: int = None
           ) -> ndarray[_S]: ...
def roll(a: _ArrayLike[_S], shift: AxesType,
         axis: AxesType = None) -> ndarray[_S]: ...
def sort(a: _ArrayLike[_S], axis: int = None, kind: str = 'quicksort',
         order: Union[str, Sequence[str]] = None) -> ndarray[_S]: ...
...
def transpose(a: _ArrayLike[_S], axes: AxesType = None) -> ndarray[_S]: ...
def resize(a: _ArrayLike[_S], new_shape: ShapeType, refcheck: bool = True) -> ndarray[_S]: ...
...
@overload
def ceil(x: float, out: float = None) -> int: ...
@overload
def ceil(x: ArrayTypeFloat, out: ndarray[_U] = None) -> ndarray[int]: ...
@overload
def clip(x: _ArrayLike[floating], a_min: float, a_max: float, out: ndarray[floating] = None
         ) -> ndarray[floating]: ...
@overload
def clip(x: _ArrayLike[floating], a_min: _ArrayLike[floating], a_max: _ArrayLike[floating],
         out: ndarray[floating] = None) -> ndarray[floating]: ...
@overload
def deg2rad(x: float, out: float = None) -> float: ...
@overload
def deg2rad(x: ArrayTypeFloat, out: ndarray[float] = None) -> ndarray[float]: ...
@overload
def exp(x: float, out: float = None) -> float: ...
@overload
def exp(x: ArrayTypeFloat, out: ndarray[_U] = None) -> ndarray[float]: ...
@overload
def floor(x: float, out: float=None) -> int: ...
@overload
def floor(x: ArrayTypeFloat, out: ndarray[_U]=None) -> ndarray[int]: ...
@overload
def log(x: float, out: float=None) -> float: ...
@overload
def log(x: ArrayTypeFloat, out: ndarray[_U]=None) -> ndarray[float]: ...
@overload
def log2(x: float, out: float=None) -> float: ...
@overload
def log2(x: ArrayTypeFloat, out: ndarray[_U]=None) -> ndarray[float]: ...
@overload
def log10(x: float, out: float=None) -> float: ...
@overload
def log10(x: ArrayTypeFloat, out: ndarray[_U]=None) -> ndarray[float]: ...
@overload
...
@overload
def sinc(x: ndarray[floating]) -> ndarray[floating]: ...
@overload
...
@overload
def sin(x: float, out: float = None) -> float: ...
@overload
def sin(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def sinh(x: float, out: float = None) -> float: ...
@overload
def sinh(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def arcsin(x: float, out: float = None) -> float: ...
@overload
def arcsin(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def cos(x: float, out: float = None) -> float: ...
@overload
def cos(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def arccos(x: float, out: float = None) -> float: ...
@overload
def arccos(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def tan(x: float, out: float = None) -> float: ...
@overload
def tan(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def tanh(x: float, out: float = None) -> float: ...
@overload
def tanh(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def arctan(x: float, out: float = None) -> float: ...
@overload
def arctan(x: _ArrayLike[Any], out: ndarray[Any] = None) -> ndarray[Any]: ...
@overload
def arctan2(x1: float, x2: float, out:float = None) -> float:...
@overload
def arctan2(x1: _ArrayLike[float], x2: _ArrayLike[float], out: ndarray[float] = None) -> ndarray[float]: ...



def indices(shape: ShapeType, dtype: DtypeType = int_) -> ndarray[Any]: ...

@overload
def sum(a: ndarray[_S]) -> _S: ... # This sum function has only array and is complete sum into a scalar
@overload
def sum(a: ndarray[_S], *, axis: AxesType, dtype: DtypeType=None, out: ndarray[_U]=None,
            keepdims: bool=False) -> ndarray[_S]: ... # Overloaded sum has mandatory axis and return an array 
# TODO: fix that dtype is ignored
